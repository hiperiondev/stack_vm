/*
 * from: https://github.com/endurodave/C_Allocator
 */
...
#define ALLOC_DEFINE(_name_, _size_, _objects_) \
            ...
            static ALLOC_Allocator _name_##Obj = { #_name_, _name_##Memory, _size_, ALLOC_BLOCK_SIZE(_size_), _objects_, NULL, 0, 0, 0, 0, 0 }; \
